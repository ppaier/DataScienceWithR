...
options(scipen=5)
opts_chunk$set(echo=TRUE, fig.height=7,fig.width=15)
```
...
```{r processdata1, echo=TRUE, cache = TRUE}
...
```{r processdata2, echo=TRUE, cache = TRUE} 
...
```{r processdata3, echo=TRUE, cache = TRUE} 
